...
//        ], 200);
    ...
    public function delete(Request $request): JsonResponse
    {
        try {
            ...
            $image_path = public_path('/storage/app/product/') . $product->image;
    ...
    public function deleteNew(Request $request): JsonResponse
    {
        try {
            ...
            $image_path = public_path('/storage/app/product/') . $productNew->image;
            if (!is_null($image_path)) {
                $productNew->delete();
                if (file_exists($image_path)) {
                    unlink($image_path);
    ...
    public function deleteShop(Request $request): JsonResponse
    {
        try {
            ...
            $image_path = public_path('/storage/app/product/') . $shop->image;
            if (!is_null($image_path)) {
                $shop->delete();
                if (file_exists($image_path)) {
                    unlink($image_path);
    ...
    public function deleteTank(Request $request): JsonResponse
    {
        try {
            ...
            $image_path = public_path('/storage/app/product/') . $tank->image;
            if (!is_null($image_path)) {
                $tank->delete();
                if (file_exists($image_path)) {
                    unlink($image_path);
