...
class ProductNewController extends Controller
{
    ...
    public function codeSearch(Request $request): JsonResponse
    {
        ...
        $productNewByCode = $this->productNew->latest()->paginate($limit, ['*'], 'page', $offset);
        $productNews = ProductNewsResource::collection($productNewByCode);
        return response()->json($productNews, 200);
    }
