...
class SettingController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'base_urls' => [
                'category_image_url' => asset('storage/app/category'),
                'brand_image_url' => asset('storage/app/brand'),
                'product_image_url' => asset('storage/app/product'),
                'supplier_image_url' => asset('storage/app/supplier'),
                'shop_image_url' => asset('storage/app/shop'),
                'admin_image_url' => asset('storage/app/admin'),
                'customer_image_url' => asset('storage/app/customer'),
            ],
            'time_zone' => TIME_ZONE,
