            ...
            <table
                ...
                <thead class="thead-light">
                    <tr>
                        ...
                        <th>{{\App\CPU\translate('car_id')}}</th>
                        <th>{{\App\CPU\translate('paid/unpaid')}}</th>
                    ...
                    @foreach($orders as $key => $order)
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            @else
                                <td> {{ $order->car_id}}</td>
                            @endif
                            @if ($order->is_paid_for_car_fee == 1)
                                <td> Paid</td>
                            @elseif($order->is_paid_for_car_fee == 0)
                                <td> Unpaid</td>
                            @else
                                <td></td>
                            @endif
