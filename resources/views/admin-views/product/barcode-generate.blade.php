                            ...
                            <tbody>
                                <tr>
                                    <form action="{{ url()->current() }}" method="GET">
                                        ...
                                        <th>
                                            <button class="btn btn-info" type="submit">{{\App\CPU\translate('generate_bercode')}}</button>
                                            <a class="btn btn-danger"
                                               href="{{ route('admin.product.barcode-generate',[$product['id']]) }}">{{\App\CPU\translate('reset')}}
                                            </a>
                                            <button type="button" id="print_bar" data-name="printarea" class="btn btn-primary print-div">{{\App\CPU\translate('print')}}</button>
                                        </th>
                                    </form>
                                </tr>
                            </tbody>
