        ...
        <div class="">
            <div class="d-flex align-items-center g-2px align-items-center mb-3">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize">
                    <i class="tio-files"></i> <span>{{\App\CPU\translate('product_list')}}
                <span class="badge badge-soft-dark ml-2">{{$products->total()}}</span></span>
                </h1>
                <div class="ml-auto">
                    <a href="{{route('admin.product.add')}}" class="btn btn-primary"><i class="tio-add-circle"></i> {{\App\CPU\translate('add')}} {{\App\CPU\translate('new')}} {{\App\CPU\translate('product')}}
                    </a>
                </div>
            </div>
        </div>
                                ...
                                <form action="{{url()->current()}}" method="GET">
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                               placeholder="{{\App\CPU\translate('search_by_product_name')}}" aria-label="{{\App\CPU\translate('Search')}}" value="{{ $search }}" required>
                    ...
                    <div class="table-responsive datatable-custom">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <div class="d-inline">
                                                <a class="btn btn-white mr-1 form-alert" href="javascript:"
                                                   ...
                                                   data-message="{{ \App\CPU\translate('Want to delete this product') }}?"><span class="tio-delete"></span></a>
                        ...
                        @if(count($products)==0)
                            <div class="text-center p-4">
                                <img class="mb-3 img-two-plst" src="{{asset('public/assets/admin')}}/svg/illustrations/sorry.svg" alt="{{ \App\CPU\translate('Image Description')}}">
                ...
                <div class="modal-body">
                    <form action="{{route('admin.stock.update-quantity')}}" method="post" class="row">
                        ...
                        <div class="form-group col-sm-12">
                            <label>{{\App\CPU\translate('quantity')}}
                            </label>
