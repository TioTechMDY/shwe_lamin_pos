...
<div class="col-sm-6 col-lg-4 mb-3 mt-3 mb-lg-5">
    <a class="card card-hover-shadow h-100 color-two" href="{{route('admin.account.list-income')}}">
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div>
...
<div class="col-sm-6 col-lg-4 mb-3 mt-3 mb-lg-5">
    <a class="card card-hover-shadow h-100 color-three" href="{{route('admin.account.list-expense')}}">
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div>
