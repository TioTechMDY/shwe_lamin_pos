...
@section('title', \App\CPU\translate('shop_setup'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize">{{ \App\CPU\translate('shop_setup') }}</h1>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.business-settings.update-setup') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shop_name" value="{{ $shopName }}"
                                            class="form-control" placeholder="{{ \App\CPU\translate('shop_name') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="shop_email" value="{{ $shopEmail }}"
                                            class="form-control" placeholder="{{ \App\CPU\translate('shop_email') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shop_phone" value="{{ $shopPhone }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('shop_phone') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shop_address" value="{{ $shopAddress }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('shop_address') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input min="1" type="number" name="pagination_limit" value="{{ $paginationLimit }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('pagination_limit') }}" id="pagination_limit" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    <div class="form-group">
                                        <label class="input-label" for="country">{{ \App\CPU\translate('country') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="footer_text" value="{{ $footerText }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('footer_text') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="stock_limit" value="{{ $stockLimit }}" min="1"
                                               class="form-control" placeholder="{{ \App\CPU\translate('stock_limit') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('time_zone') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" type="text" name="vat_reg_no"
                                               placeholder="{{ \App\CPU\translate('vat_reg_no') }}" value="{{ $vatRegNo }}">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="text-center">
                                            <img class="img-one-bs my-4" id="viewer"
                                                 src="{{onErrorImage($shopLogo,asset('storage/app/public/shop').'/' . $shopLogo,asset('public/assets/admin/img/160x160/img2.jpg') ,'shop/')}}" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group ">
                                        <label>{{ \App\CPU\translate('fav_icon') }}</label><small class="text-danger">* ( {{ \App\CPU\translate('ratio_1:1') }} )</small>
                                        <div class="custom-file">
                                            <input type="file" name="fav_icon" id="customFileEg2" class="custom-file-input"
                                                   accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            <label class="custom-file-label" for="customFileEg2">{{ \App\CPU\translate('choose') }}{{ \App\CPU\translate('file') }}</label>
                                        </div>
                                        <div class="text-center">
                                            <img class="img-one-bs my-4" id="viewer2"
                                                 src="{{onErrorImage($favIcon, asset('storage/app/public/shop').'/' . $favIcon, asset('public/assets/admin/img/160x160/img2.jpg') ,'shop/')}}" alt="{{ \App\CPU\translate('fav_icon') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <button type="submit"
                                class="btn btn-primary mb-2">{{ \App\CPU\translate('submit') }}</button>
                        </form>
                    </div>
                </div>
            </div>
